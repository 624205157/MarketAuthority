...
//                setData(backlogBean);
    ...
    private void setData() {
        et_unit.setText("锅炉制造");//许可类别
        et_legal.setText("锅炉");//许可子项
        et_createtime.setText("锅炉B级");//许可级别
        et_assets.setText("无");//参数
        et_funds.setText("吉大正元");//形式试验单位
        et_address.setText("无");//代表产品

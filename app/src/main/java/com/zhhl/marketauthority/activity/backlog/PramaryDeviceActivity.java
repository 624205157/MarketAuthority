...
public class PramaryDeviceActivity extends BaseActivity {
    ...
    PramaryDeviceBean.ObjBean.ResBean resBean;
    ...
    private void getData() {
        ...
        resBean = (PramaryDeviceBean.ObjBean.ResBean) getIntent().getExtras().get("data");
        setData(resBean);
    ...
    private void uploadData() {
        ...
        map.put("id",resBean.getN_E_ID());
        map.put("tjlx","7");
        map.put("v_e_name",name_device);
        map.put("v_e_type",device_type);
        map.put("d_e_begin",use_date);
        map.put("v_e_num",count_device);
        map.put("v_e_perfor",equipment_devcie);
    ...
    private void setData(PramaryDeviceBean.ObjBean.ResBean resBean) {
        et_name_device.setText(resBean.getV_E_NAME());//cl_1 仪器设备名称
        et_equipment_devcie.setText(resBean.getV_E_PERFOR());//cl_1 仪器设备能力
        et_count_device.setText(resBean.getV_E_NUM());//cl_1 仪器设备数
        et_device_type.setText(resBean.getV_E_TYPE());//规格型号
        et_use_data.setText(resBean.getD_E_BEGIN());//投用日期
    ...
    private void init() {
        ...
        adapter = new GridImageSecAdapter(PramaryDeviceActivity.this, onAddPicClickListener,onDelete);

...
//                mAdapter.setToChange(true);
    ...
    private void init() {
        ...
        adapter = new GridImageAdapter(InspectDeviceActivity.this, onAddPicClickListener);
        ...
        recycler2.addItemDecoration(new GridSpacingItemNotBothDecoration(5,
                ScreenUtils.dip2px(InspectDeviceActivity.this, 4), true, false));
        adapter2 = new GridImageSecAdapter(InspectDeviceActivity.this, onAddPicClickListener2);
        ...
        recycler3.addItemDecoration(new GridSpacingItemNotBothDecoration(5,
                ScreenUtils.dip2px(InspectDeviceActivity.this, 4), true, false));
        adapter3 = new GridImageThiAdapter(InspectDeviceActivity.this, onAddPicClickListener3);
    ...
    private GridImageAdapter.onAddPicClickListener onAddPicClickListener = new GridImageAdapter.onAddPicClickListener() {
        ...
        public void onAddPicClick() {
            ...
            manager = new FullyGridLayoutManager(InspectDeviceActivity.this,
    ...
    private GridImageSecAdapter.onAddPicClickListener onAddPicClickListener2 = new GridImageSecAdapter.onAddPicClickListener() {
        ...
        public void onAddPicClick() {
            ...
            manager2 = new FullyGridLayoutManager(InspectDeviceActivity.this,
    ...
    private GridImageThiAdapter.onAddPicClickListener onAddPicClickListener3 = new GridImageThiAdapter.onAddPicClickListener() {
        ...
        public void onAddPicClick() {
            ...
            manager3 = new FullyGridLayoutManager(InspectDeviceActivity.this,

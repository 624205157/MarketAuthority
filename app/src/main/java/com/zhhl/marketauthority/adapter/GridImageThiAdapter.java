...
public class GridImageThiAdapter extends
        RecyclerView.Adapter<GridImageThiAdapter.ViewHolder> {
    ...
    public GridImageThiAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
...
//            tvDuration = view.findViewById(R.id.tv_duration);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = mInflater.inflate(R.layout.girdview_image3,
                viewGroup, false);

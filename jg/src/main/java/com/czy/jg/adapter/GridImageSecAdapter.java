...
//            tvDuration = view.findViewById(R.id.tv_duration);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = mInflater.inflate(R.layout.jg_girdview_image,
                viewGroup, false);
...
//                }
            ...
            if (path!=null && path.startsWith("/storage/")){
                ...
                Glide.with(viewHolder.itemView.getContext())
                        .load(UrlConfig.PATH_SHOW_IMG+"?mogondbId="+id+"&mediatype="+type)
//                    .load(UrlConfig.PATH_SHOW_IMG+"?mogondbId="+list.get(position).getPath()+"mediatype="+list.get(position).getType())

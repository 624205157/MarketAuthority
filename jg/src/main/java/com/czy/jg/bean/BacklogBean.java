...
public class BacklogBean {
    ...
    public static class ObjBean {
        ...
        private List<JgCompany> iclicJgCompany;//基本信息
        private List<Hzxm> hzxmList;
        ...
        public List<JgCompany> getIclicJgCompany() {
            return iclicJgCompany;
        }

        public void setIclicJgCompany(List<JgCompany> iclicJgCompany) {
            this.iclicJgCompany = iclicJgCompany;
        }

        public List<Hzxm> getHzxmList() {
            return hzxmList;
        }

        public void setHzxmList(List<Hzxm> hzxmList) {
            this.hzxmList = hzxmList;
        }
    ...
    public class Hzxm {
        private String hztier;//检验检测类型
        private String hzproject;//检验检测项目
        private String permittype;//申请核准
        private String projectcode;//新申请核准

        public String getHztier() {
            return hztier;
        }

        public void setHztier(String hztier) {
            this.hztier = hztier;
        }

        public String getHzproject() {
            return hzproject;
        }

        public void setHzproject(String hzproject) {
            this.hzproject = hzproject;
        }
